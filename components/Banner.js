...
export default function Banner() {
    return (
        <div className="w-full h-screen flex flex-col grid grid-cols-1 sm:grid-cols-2">
            <div className="col-span-1 flex flex-col mx-auto sm:mx-4 mt-auto sm:my-auto mb-8 sm:my-auto">
            ...
            <div className="col-span-1 flex flex-col mx-auto sm:mx-4 mb-auto sm:my-auto mt-8 sm:my-auto">
